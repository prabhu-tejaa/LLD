...
Now anyone can make an Object of 'SportsCar1' and can assign it to 'Car' reference.
...
when we press these buttons. 'SportsCar1' class denotes that actual implementation.
...
And another one to denote the actual car with all the implementations of these buttons (SportsCar1' class).
 */
