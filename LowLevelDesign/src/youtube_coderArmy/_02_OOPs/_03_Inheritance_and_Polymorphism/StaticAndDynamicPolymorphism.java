...
// this has all 4 OOPs concepts -  abstraction, inheritance, encapsulation, polymorphism
abstract class Car4 {
...
class ManualCar4 extends Car4 {
    private int currentGear;

    public ManualCar4(String brand, String model) {
        super(brand, model);
        this.currentGear = 0;
    }
...
class ElectricCar4 extends Car4 {
    private int batteryLevel;

    public ElectricCar4(String brand, String model) {
        super(brand, model);
...
public class StaticAndDynamicPolymorphism {
    public static void main(String[] args) {
        Car4 myManualCar = new ManualCar4("Ford", "Mustang");
        ...
        Car4 myElectricCar = new ElectricCar4("Tesla", "Model S");
